  ...
  return (
    <PortalLayout role="responsavel">
      <div className="max-w-5xl mx-auto">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-neutral-900 mb-2">Agenda Escolar</h1>
          <p className="text-gray-600">Próximos eventos, provas e atividades</p>
        </div>
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-2">
                        <span className={`text-xs font-semibold px-3 py-1 rounded-full ${
                          ...
                          evento.type === 'feriado' ? 'bg-gray-100 text-gray-700' :
                          'bg-green-100 text-green-700'
                        }`}>
                          {evento.type === 'prova' ? 'Avaliação' : 
                           evento.type === 'reuniao' ? 'Reunião' :
                           evento.type === 'feriado' ? 'Feriado' : 'Evento'}
                        </span>
