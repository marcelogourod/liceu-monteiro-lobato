...
**Lelouch sempre orquestra:** Enquanto você roda, Lelouch permanece `"running"`. Se invocado sem `/lelouch`, defina-o como `"running"` com `task: "Supervisionando Snake"`. Só coloque-o em `"done"` se você for o ÚLTIMO agente a finalizar.
